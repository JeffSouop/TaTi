...
const PRESETS: Array<{ label: string; name: string; url: string; hint: string }> = [
  ...
  { label: "GitHub", name: "GitHub", url: "https://YOUR-TUNNEL/github/mcp", hint: "Issues/PR/Repo via serveur MCP GitHub (token via Headers)" },
  { label: "GitLab", name: "GitLab", url: "https://YOUR-TUNNEL/gitlab/mcp", hint: "Issues/MR/Projects via serveur MCP GitLab (token via Headers)" },
